...
function ArrayAndObject(){
  ...
  obj1.Obj_property_1 = 'value1'; //obj1방식의 경우 값은 이런식으로 대입한다.
  console.log('new Object(), propertyVal: ' + obj1.Obj_property_1); //value1
  ...
  obj[0] = 'zero';  //객체 내에 프로퍼티가 저장될 때 숫자~문자 순으로 정렬이된다.
